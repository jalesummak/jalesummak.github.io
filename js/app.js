(function () {
  ...
  var APPS = [
    { id: 1, key: "EyeGuide AI", family: ["Health & Accessibility", "Sağlık & Erişilebilirlik", "Здоровье и доступность", "Salomatlik va qulaylik"], url: "https://eyeguide.tbctechai.com/", desc: ["AI that helps people see, understand and navigate with confidence.", "İnsanların güvenle görmesine, anlamasına ve yön bulmasına yardım eden AI.", "ИИ, помогающий людям видеть, понимать и ориентироваться уверенно.", "Odamlarga ishonch bilan ko'rish, tushunish va yo'l topishda yordam beradigan AI."] },
    { id: 2, key: "AgroLens AI", family: ["Agriculture & Nature", "Tarım & Doğa", "Сельское хозяйство и природа", "Qishloq xo'jaligi va tabiat"], url: "https://agrolens.tbctechai.com/", desc: ["Turn one photo into a clear, explainable field insight.", "Tek bir fotoğrafı net, açıklanabilir bir saha içgörüsüne dönüştürür.", "Превращает одно фото в ясную, объяснимую полевую аналитику.", "Bitta fotosuratni aniq, tushunarli dala tahliliga aylantiradi."] },
    { id: 3, key: "CityPulse AI", family: ["Cities & Environment", "Şehirler & Çevre", "Города и окружающая среда", "Shaharlar va atrof-muhit"], url: "https://citypulse.tbctechai.com/", desc: ["Understand the signals shaping safer, healthier cities.", "Daha güvenli ve sağlıklı şehirleri şekillendiren sinyalleri anlayın.", "Понять сигналы, формирующие более безопасные и здоровые города.", "Xavfsizroq va sog'lomroq shaharlarni shakllantiruvchi signallarni tushuning."] },
    { id: 4, key: "TrustLens AI", family: ["Trust, Safety & Language", "Güven, Güvenlik & Dil", "Доверие, безопасность и язык", "Ishonch, xavfsizlik va til"], url: "https://trustlens.tbctechai.com/", desc: ["Check language, tone and content risk in one calm workflow.", "Dil, ton ve içerik riskini tek sakin akışta kontrol edin.", "Проверьте язык, тон и риски контента в одном спокойном процессе.", "Til, ohang va kontent xavfini bitta sokin oqimda tekshiring."] },
    { id: 5, key: "RecoMuse AI", family: ["Personalized Discovery", "Kişiselleştirilmiş Keşif", "Персонализированное открытие", "Shaxsiylashtirilgan kashfiyot"], url: "https://recomuse.tbctechai.com/", desc: ["A personal discovery layer shaped around what you actually enjoy.", "Gerçekten sevdikleriniz etrafında şekillenen kişisel keşif katmanı.", "Личный слой открытий, построенный вокруг того, что вам нравится.", "Siz haqiqatan ham yoqtirgan narsalar atrofida qurilgan shaxsiy kashfiyot qatlami."] },
    { id: 6, key: "BizPilot AI", family: ["Business & Forecasting", "İş & Tahminleme", "Бизнес и прогнозирование", "Biznes va bashorat"], url: "https://bizpilot.tbctechai.com/", desc: ["Move from raw numbers to the next best business decision.", "Ham sayılardan bir sonraki en iyi iş kararına geçin.", "От сырых чисел к следующему лучшему бизнес-решению.", "Xom raqamlardan keyingi eng yaxshi biznes qaroriga o'ting."] },
    { id: 7, key: "CareerPath AI", family: ["Career & Education", "Kariyer & Eğitim", "Карьера и образование", "Karyera va ta'lim"], url: "https://careerpath.tbctechai.com/", desc: ["Translate market data into a focused, personal growth route.", "Piyasa verisini odaklı, kişisel bir gelişim yoluna çevirin.", "Превратите данные рынка в сфокусированный личный маршрут роста.", "Bozor ma'lumotini fokuslangan shaxsiy o'sish yo'liga aylantiring."] },
    { id: 8, key: "VisionForge AI", family: ["CNN & Visual Intelligence", "CNN & Görsel Zekâ", "CNN и визуальный интеллект", "CNN va vizual intellekt"], url: "https://visionforge.tbctechai.com/", desc: ["Train the eye of an AI system, then explore how it classifies and communicates uncertainty.", "Bir AI sisteminin gözünü eğitin, ardından nasıl sınıflandırdığını ve belirsizliği nasıl ilettiğini keşfedin.", "Обучите глаз ИИ-системы и исследуйте, как она классифицирует и передаёт неопределённость.", "AI tizimining ko'zini o'rgating, so'ng qanday tasniflashini va noaniqlikni qanday yetkazishini o'rganing."] }
  ];
  ...
  function svgVisual(p, cat) {
    ...
    return '<svg viewBox="0 0 480 210" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" role="img" aria-label="' + esc(p.title) + '">' +
      ...
      '<stop offset="0" stop-color="' + rgba(c, 0.55) + '"/><stop offset="1" stop-color="' + rgba(c, 0.12) + '"/></linearGradient>' +
